...
public class AtcController {
    public AtcController() {
        ...
        Plane EK71 = new Plane("EK61", "midair", 39025,498,"EK61", "B77W","A6- EQB", "Qantas", "FRA", "DXB", 7.00, 14.00, 200, 14,"taking off", "delayed"); // in the final version we can load chunks of
